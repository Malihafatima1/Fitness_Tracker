...
const Onboarding = () => {
  ...
  const handleNext = async () => {
    ...
    if (step < totalSteps) {
      ...
      localStorage.setItem("fitnessUser", JSON.stringify(usreData));
      
      try {
        await api.put(`/api/users/${user?.id}`,usreData)
          ...
          {step === 1 && (
            <div className="space-y-6">
              <div className="flex items-center gap-4 mb-8">
                <div
                  className="size-12 rounded-xl  bg-emerald-50 dark:bg-emerald-900 border border-emerald-100
 ...
 dark:border-emerald-800 flex items-center justify-center"
              ...
              {/**Daily Targest */}
              <div className="spce-y-8 max-w-lg">
