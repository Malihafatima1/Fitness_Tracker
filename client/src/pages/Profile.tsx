...
const Profile = () => {
  ...
  const handleSave = async () => {
    try {
      await api.put(`/api/users/${user?.id}`,fromData)
        ...
        <Card>
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-slate-500 dark:text-slte-400 text-xs">
                Member since{" "}
          ...
          {isEditing ? (
            <div className="space-y-4">
              <Input
                ...
                type="number"
                value={fromData.age}
                onChange={(v) => setFormData({ ...fromData, age: Number(v) })}
                min={130}
                max={120}
              />
              ...
              <Input
                label="Weight (kg)"
                type="number"
                value={fromData.weight}
                onChange={(v) =>
                  setFormData({ ...fromData, weight: Number(v) })
                }
                min={20}
                max={300}
              />
              ...
              <Input
                label="Height (cm)"
                type="number"
                value={fromData.height}
                onChange={(v) =>
                  setFormData({ ...fromData, height: Number(v) })
                }
                min={100}
                max={250}
              />
