...
const Dashboard = () => {
  ...
  const remainingCalories: number = DAILY_CALORY_LIMIT - totalCalories;
    ...
    <div className="page-container">
      ...
      <div className="dashboard-grid">
        ...
        <Card className="shadow-lg col-span-2">
          ...
          <ProgressBar value={totalCalories} max={DAILY_CALORY_LIMIT} />
          ...
          <div className="mt-4 flex justify-between items-center">
            ...
            >
              <span className="text-sm font-medium">
                {remainingCalories >= 0
                  ? `${remainingCalories} kal remaining`
                  : `${Math.abs(remainingCalories)} kal over`}
              </span>
            </div>

            <span className="text-sm text-slate-400">
              {Math.round((totalCalories / DAILY_CALORY_LIMIT) * 100)}%
            </span>
          </div>
          ...
          <Card>
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-slate-500 text-sm">Your satus</p>
              </div>
            </div>
                ...
                <div className="pt-2 border-t border-slate-100 dark:border-slate-800">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    {(() => {
                      ...
                      const status = getSatus(Number(bmi));
                      return (
